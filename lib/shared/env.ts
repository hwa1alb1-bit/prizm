...
const serverSchema = z.object({
  ...
  DOCUMENT_STORAGE_PROVIDER: z.enum(['s3', 'r2']).default('s3'),
  DOCUMENT_EXTRACTION_PROVIDER: z.enum(['textract', 'cloudflare-r2']).default('textract'),
  R2_ACCOUNT_ID: z.string().optional(),
  R2_UPLOAD_BUCKET: z.string().optional(),
  R2_ACCESS_KEY_ID: z.string().optional(),
  R2_SECRET_ACCESS_KEY: z.string().optional(),
  CLOUDFLARE_EXTRACTOR_URL: z.string().url().optional(),
  CLOUDFLARE_EXTRACTOR_TOKEN: z.string().optional(),
