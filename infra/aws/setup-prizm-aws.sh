...
aws s3api put-bucket-cors \
  ...
  --cors-configuration '{
    "CORSRules": [{
      ...
      "AllowedOrigins": ["https://pdftoexcelstatementconverter.com", "https://www.pdftoexcelstatementconverter.com", "https://prizmview.app", "https://www.prizmview.app", "https://*.vercel.app", "http://localhost:3030"],
      "ExposeHeaders": ["ETag"],
      "MaxAgeSeconds": 3000
    }]
  }'
