...
$f = Write-Tmp '{"CORSRules":[{"AllowedHeaders":["*"],"AllowedMethods":["PUT","GET"],"AllowedOrigins":["https://pdftoexcelstatementconverter.com","https://www.pdftoexcelstatementconverter.com","https://*.vercel.app","http://localhost:3030"],"ExposeHeaders":["ETag"],"MaxAgeSeconds":3000}]}'
